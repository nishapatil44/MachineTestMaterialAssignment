    ...
    <div class="data-list">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $count }}</td>
                    <td>{{ $io['material_name'] }}</td>
                    <td>{{ $io['category_name'] }}</td>
                    <td>{{ $io['opening_balance'] }}</td>
                    <td>{{ $io['current_balance'] }}</td>
                    <td>{{ $io['updated_at'] }}</td>
                    <td>
                        <!-- <button onclick="viewItem()">View</button>
                        <button onclick="editItem()">Edit</button>
                        <button onclick="deleteItem()">Delete</button> -->
                        <a href="{{ route('iomaster.create') }}" title="View"><i class="fas fa-plus"></i></a>
                        <a href="{{ route('iomaster.edit', ['id' => $io['id']]) }}" title="Edit"><i class="fas fa-edit"></i></a>
                        <a href="{{ route('iomaster.delete', ['id' => $io['id']]) }}" title="Delete"><i class="fas fa-trash-alt"></i></a>
                    </td>
                </tr>
                @php
                    $count++;
...
<script>
    function viewItem() {
        alert('View item clicked');
        // Add your view item functionality here
    }
