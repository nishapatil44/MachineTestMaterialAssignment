        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('categories.create') }}" title="View"><i class="fas fa-plus"></i></a>
                        <a href="{{ route('categories.edit', ['id' => $category['id']]) }}" title="Edit"><i class="fas fa-edit"></i></a>
                        <a href="{{ route('categories.delete', ['id' => $category['id']]) }}" title="Delete"><i class="fas fa-trash-alt"></i></a>
                    </td>
                </tr>
                @php
                    $count++;
